          ...
          {insights.map((item, i) => {
            ...
            return (
              <motion.a
                ...
                href={item.href}
                variants={fadeUp}
                className="group flex flex-col rounded-2xl bg-surface border border-border hover:border-violet-600/60 transition-all overflow-hidden"
              >
                {/* Visual header */}
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  <p className="text-zinc-500 text-xs leading-relaxed flex-1">{item.excerpt}</p>
