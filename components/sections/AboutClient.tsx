...
import type { Office } from "@/lib/data/navigation"
...
export function AboutClient({ leaders, offices }: AboutClientProps) {
  return (
    <PageTransition>
      <main className="pt-24">
        ...
        <section className="py-24 bg-bg" id="culture">
              ...
              {leaders.map((l, i) => (
                ...
                >
                  ...
                  <a
                    ...
                    aria-label={`LinkedIn profile of ${l.name}`}
                  >
        ...
        {/* Offices */}
        <section className="py-24 bg-bg" id="geography">
          <div className="max-w-7xl mx-auto px-6">
